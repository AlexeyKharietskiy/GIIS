...
class ParabolaInputWindow(Window):
    ...
    def create_widgets(self):
        ...
        frame_point2 = tk.LabelFrame(self, text="Коэффициент ширины параболы", padx=10, pady=10)
        frame_point2.grid(row=0, column=1, padx=10, pady=10, sticky="nsew")
        tk.Label(frame_point2, text="P:").grid(row=0, column=0, padx=5, pady=5)
    ...
    def return_data(self):
        try:
            ...
            self.destroy()
            self.controller.set_model_info((x, y), a, self.debug_mode)
        except ValueError:
            self.destroy()
